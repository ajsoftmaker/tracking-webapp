...
function adduserController($scope,$rootScope,$state,dialogs,restAPIService,$location){
	...
	$scope.tennatStreetValid = false;
	$scope.tennatStreetSuccess = false;
	$scope.tennatStreetError = false;
	$scope.tennatStreetFeedback = "";
	
	$scope.tennatLandmarkValid = false;
	$scope.tennatLandmarkSuccess = false;
	$scope.tennatLandmarkError = false;
	$scope.tennatLandmarkFeedback = "";
	
	$scope.tennatCityValid = false;
	$scope.tennatCitySuccess = false;
	$scope.tennatCityError = false;
	$scope.tennatCityFeedback = "";
	...
	$scope.validStreet = function(valid){
		$scope.tenantStreetValid = valid;
		if($scope.tenant.street != undefined) {
			if($scope.tenant.street.length <= 0) {
				$scope.tenantStreetError = true;
				$scope.tenantStreetFeedback = "has-error has-feedback";
			} else {
				$scope.tenantStreetSuccess = true;
				$scope.tenantStreetError = false;
				$scope.tenantStreetFeedback = "has-success has-feedback";
			}
		} else {
			$scope.tenantStreetError = true;
			$scope.tenantStreetSuccess = false;
			$scope.tenantStreetFeedback = "has-error has-feedback"; 
		}
	}
