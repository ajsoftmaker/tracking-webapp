...
angular.module('trackingWebApp').controller('testController',testController);

function testController($scope, $rootScope, $state, $filter, dialogs,restAPIService, $location,$timeout,$window) {
