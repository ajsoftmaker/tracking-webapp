...
angular.module('trackingWebApp').controller('manageclientsController',manageclientsController);

function manageclientsController($scope, $rootScope, $state, dialogs,
...
//	getTenants();
	...
	$scope.onEdit = function(tenant) {
		...
		$scope.mode = "edit";
		$scope.id = tenant.id;
		$state.go("home.tamanageclients.taaddclient");
	}
