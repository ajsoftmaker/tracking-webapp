...
angular.module('trackingWebApp').controller('managereportsController',managereportsController);

function managereportsController($scope, $rootScope, $state, dialogs,
...
//		});
	...
	$scope.onEdit = function(tenant) {
		...
		$scope.mode = "edit";
		$scope.id = tenant.id;
		$state.go("home.tamanageusers.taadduser");
	}
